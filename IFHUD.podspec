#
#  Be sure to run `pod spec lint IFHUD.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.resources = 'Sources/IFHUD/*.bundle'
  spec.source_files = 'Sources/IFHUD/*.{h,m}'
  spec.public_header_files = 'Sources/IFHUD/*.h'
