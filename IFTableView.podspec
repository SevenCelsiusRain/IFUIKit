#
#  Be sure to run `pod spec lint IFTableView.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "IFTableView"
  spec.version      = "0.0.0.6"
  spec.summary      = "tableview"
  ...
  spec.source_files = 'Sources/IFTableView/*.{h,m}'
  spec.public_header_files = 'Sources/IFTableView/*.h'
